                    ...
                    <div class="col-2 col-sm-3 col-md-3 col-lg-8">
                        ...
                        <nav class="grid__item" id="AccessibleNav"><!-- for mobile -->
                            <ul id="siteNav" class="site-nav medium center hidearrow">
                                <li class="lvl1 parent megamenu"><a href="/commerce">Home <i class="anm anm-angle-down-l"></i></a>

                                </li>
                                <li class="lvl1 parent megamenu"><a href="/shop">Shop <i class="anm anm-angle-down-l"></i></a>
                                </li>
        ...
        <div class="mobile-nav-wrapper" role="navigation">
            ...
            <ul id="MobileNav" class="mobile-nav">
              ...
              <ul>
                ...
                <li class="lvl1 parent megamenu"><a href="/prod">Product <i class="anm anm-plus-l"></i></a>
              <ul>
                <li><a href="/prod" class="site-nav">Product Page<i class="anm anm-plus-l"></i></a>
                  <ul>
                    <li><a href="/produ" class="site-nav">Product Layout 1</a></li>
                    ...
                    <div class="productSlider-fullwidth grid-products grid-products-hover-btn">
                        <div class="col-12 item">
                            ...
                            <div class="product-image">
                                <!-- start product image -->
                                <a href="/product" class="grid-view-item__link">
                                    <!-- image -->
                                ...
                                <form class="variants add" action="#" onclick="window.location.href='/cart'"method="post">
                        ...
                        <div class="col-12 item">
                            ...
                            <div class="product-details text-center">
                                <!-- product name -->
                                <div class="product-name">
                                    <a href="/product">3/4 Sleeve Kimono Dress</a>
                                </div>
                                <!-- End product name -->
                                <!-- product price -->
                                <div class="product-price">
                    ...
                    <div class="footer-top">
                        <div class="row">
                            <div class="col-12 col-sm-12 col-md-3 col-lg-3 contact-box">
                                ...
                                <p>Belle Multipurpose Bootstrap 4 Html Template with clean &amp; modern design for your online fashion store and other web shop.</p>
